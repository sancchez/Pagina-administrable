/**
 * Mapeo de iconos de lucide-react a SVG real (Frontend)
 * Este archivo resuelve el problema de que los componentes de iconos
 * no se convierten correctamente durante el renderizado TSX -> HTML
 */
 ...
 */
export function convertIconToSvg(iconName, props = {}) {
 ...
 */
export function processIconsInHtml(html) {
