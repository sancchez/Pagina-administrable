...
// Cambiar estas importaciones para usar los archivos del directorio principal
import QuienesSomos from '../../../../src/pages/QuienesSomos';
import InformacionESAL from '../../../../src/pages/InformacionESAL';
import OperacionGestion from '../../../../src/pages/OperacionGestion';
import PortalUsuario from '../../../../src/pages/PortalUsuario';
import Normatividad from '../../../../src/pages/Normatividad';
