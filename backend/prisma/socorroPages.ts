 ...
 *
 * Contenido base del sitio (diseño generado con Gemini bajo los parámetros de
 * PARAMETROS_DISENO_SEED.md: paleta segura, estilos explícitos por elemento,
 * sin bg-clip-text). El seed oficial (npm run db:seed) reproduce este contenido,
 * de modo que el deploy funciona 100% desde git, sin subir la base a mano.
 *
 ...
 *
 * Nota: si en el servidor ya existe `prisma/socorro.sqlite`, el deploy la respeta
 * (no re-siembra), para no pisar el contenido editado desde el panel /admin.
 */
...
export const socorroPages: SeedPage[] = [
  { kind: 'special', slug: '_header', title: 'Header Global', html: header },
  { kind: 'special', slug: '_footer', title: 'Footer Global', html: footer },
